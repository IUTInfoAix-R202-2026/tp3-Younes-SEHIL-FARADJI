...
public class SiteCarte extends HBox {
  ...
  public SiteCarte() {
    ...
    FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("SiteCarte.fxml"));
  ...
  private void initialize() {
    ...
    // 2. Bindings avec concaténation pour les statistiques
    ...
    // 3. Listener pour le badge de fraîcheur
